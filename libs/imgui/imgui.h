...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool disableCheckLogic = false);
    ...
    // - Adjust format string to decorate the value with a prefix, a suffix, or adapt the editing and display precision e.g. "%.2f" -> 1.23; "%5.2f secs" -> 01.23 secs; "Biscuit: %.0f" -> Biscuit: 1; etc.
    ...
    IMGUI_API bool          SliderFloat(const char* label, const ImVec2& size, float* v, float v_min, float v_max, const char* format = "%.2f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalar(const char* label, const ImVec2& size, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
