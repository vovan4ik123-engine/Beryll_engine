...
namespace Beryll
{
    ...
    void BaseSimpleObject::updateBeforePhysics()
    {

    }

    void BaseSimpleObject::updateAfterPhysics()
    {
    ...
    void BaseSimpleObject::loadGraphicsMesh(const std::string& filePath, const aiScene* scene, const aiMesh* graphicsMesh)
    {
