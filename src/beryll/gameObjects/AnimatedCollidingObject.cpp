...
namespace Beryll
{
    ...
    void AnimatedCollidingObject::setCurrentAnimationByName(const char* name, bool playOneTime, bool startEvenIfSameAnimPlaying)
    {
    ...
    void AnimatedCollidingObject::setCurrentAnimationByIndex(int index, bool playOneTime, bool startEvenIfSameAnimPlaying)
    {
    ...
    void AnimatedCollidingObject::addMaterial2(const std::string& diffusePath,
